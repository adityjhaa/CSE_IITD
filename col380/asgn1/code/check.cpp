...
int main(int argc, char* argv[]) {
    ...
    auto duration = chrono::duration<double, milli>(end - begin).count();
    cout << fixed << setprecision(2) << duration << endl;
    ...
    duration = chrono::duration<double, milli>(end - begin).count();
    cout << fixed << setprecision(2) << duration << endl;
